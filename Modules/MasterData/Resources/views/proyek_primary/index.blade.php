    		...
    		<v-card>
    			<v-card-text>
    				<table-component inline-template
    					table-number
    					with-actions
    					uri="{{ route('proyek-primary.table') }}"
    					...
    					page-text-locale="id"
    					add-new-uri="{{ route('proyek-primary.create') }}"
    					add-new-text="Tambah"
    					add-new-color="light-blue lighten-2"
                        detail-uri="proyek-primary.show"
                        detail-uri-parameter="slug"
                        detail-text="Tambah Unit"
                        detail-icon="mdi-home-plus"
    					edit-uri="proyek-primary.edit"
    					edit-uri-parameter="slug"
    					edit-text="Ubah"
    					delete-uri="proyek-primary.destroy"
