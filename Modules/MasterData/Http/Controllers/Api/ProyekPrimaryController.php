...
class ProyekPrimaryController extends Controller
{
    ...
    public function validateFormRequest($request)
    {
        return Validator::make($request->all(), [
            ...
            'status_unit' => 'bail|required|in:' . implode(',', decode_option('masterdata.status_unit')),
            ...
            'jenis_pembayaran' => 'bail|required|in:' . implode(',', decode_option('masterdata.jenis_pembayaran')),
